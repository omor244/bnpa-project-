...
import { Calendar, User, Hash, Image as ImageIcon, Upload, X, FileWarning, Banknote, Printer, Layers, Ruler, Grid2X2, Grid3X3 } from 'lucide-react';
...
export default function NewIssueForm() {
    ...
    const onSubmit = async (data) => {
        ...
        const { title, dateOfIssue, designer, image, postmarkNumber, numStamps, faceValue, printers, size, perforation, quantity, NumberofStampSheet, color, processPrinting } = data
        
        
        if (!image) {
            Toast.fire({ icon: 'error', title: 'Select A Image ' });
            return
        }
        ...
        try {
            ...
            const issueData = {
                ...
                perforation,
                quantity,
                NumberofStampEachSheet: NumberofStampSheet,
                color,
                processPrinting
            }
            ...
            const res = await axios.post("https://api.bnpa.bd/new-issue", issueData)
                            ...
                            <Card className="border-slate-200 shadow-sm">
                                <CardContent className="pt-6 space-y-5">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        ...
                                        {/* Row 2: perforation */}
                                        <div className="space-y-1">
                                            <label className="text-sm font-bold text-slate-700">Perforation</label>
                                            <div className="relative">
                                                <Grid2X2 className="absolute left-3 top-3 text-slate-400" size={18} />
                                                <Input
                                                    {...register("perforation", { required: "Perforation is required" })}
                                                    placeholder="Enter perforation"
                                                    className="pl-10 h-11 focus-visible:ring-[#26bba4]"
                                                />
                                            </div>
                                        </div>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        ...
                                        {/* Row 2: Number of Stamps sheet */}
                                        <div className="space-y-1">
                                            <label className="text-sm font-bold text-slate-700">Number of Stamps In Each Sheet</label>
                                            <div className="relative">
                                                <Grid3X3 className="absolute left-3 top-3 text-slate-400" size={18} />
                                                <Input
                                                    {...register("NumberofStampSheet", { required: "Perforation is required" })}
                                                    placeholder="Enter Number of Stamps Sheet"
                                                    className="pl-10 h-11 focus-visible:ring-[#26bba4]"
                                                />
                                            </div>
                                        </div>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        ...
                                        {/* process of printing */}
                                        <div className="space-y-1">
                                            <label className="text-sm font-bold text-slate-700">Process of Printing</label>
                                            <div className="relative">
                                                <Printer className="absolute left-3 top-3 text-slate-400" size={18} />
                                                <Input
                                                    {...register("processPrinting", { required: "Designer is required" })}
                                                    placeholder="Set Printing Process"
                                                    className="pl-10 h-11 focus-visible:ring-[#26bba4]"
                                                />
                                            </div>
                                        </div>
