...
const CheckoutOrderSummaryGuest = ({cartItems, gstIncluded, shippingCost, subtotal, selectedSpeed, orderTotal }) => {
    return (
        <div>
            <div className="bg-white border border-slate-200 rounded-md shadow-sm p-6 space-y-5">
                            ...
                            return (
                                <div key={item._id || item.id} className="flex gap-4 items-start text-xs border-b border-slate-100 pb-3">
                                    ...
                                    <div className="text-right whitespace-nowrap">
                                        {/* FIXED THE ERROR HERE: wrapping parsed value inside parentheses safely */}
                ...
                <div className="space-y-2 border-b border-slate-100 pb-3 text-xs text-slate-600">
                    ...
                    <div className="flex justify-between">
                        <span className="capitalize">Delivery ({selectedSpeed})</span>
                ...
                <button
                    ...
                    className="w-full bg-[#26bba4] disabled:bg-slate-300 disabled:cursor-not-allowed text-white font-bold py-3.5 rounded-md shadow hover:cursor-pointer hover:bg-[#26bba7] transition active:scale-[0.99]"
                >
                ...
                <div className="text-center pt-3 space-y-3">
                    {/* Bangladeshi Payment Method Badges */}
                    <div className="mt-4">
                        <img
...
export default CheckoutOrderSummaryGuest;